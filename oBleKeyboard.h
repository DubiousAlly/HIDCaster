...
#define BleMOUSE_LEFT 1
#define BleMOUSE_RIGHT 2
#define BleMOUSE_MIDDLE 4
#define BleMOUSE_BACK 8
#define BleMOUSE_FORWARD 16
#define BleMOUSE_ALL (BleMOUSE_LEFT | BleMOUSE_RIGHT | BleMOUSE_MIDDLE)
...
public:
  BleKeyboard(std::string  deviceName = "Imrryr HID", std::string  deviceManufacturer = "Newfangled Ergo", uint8_t batteryLevel = 100);
  void begin(void);
  void end(void);
  void sendReport(BleKeyReport* keys);
  void sendReport(MediaKeyReport* keys);
  void sendReport(MouseReport* );
  ...
  void bpress(uint8_t b);
  void bpress(const MouseReport b);  
  bool isPressed(uint8_t b = BleMOUSE_LEFT); // check LEFT by default
  void brelease(uint8_t b);
